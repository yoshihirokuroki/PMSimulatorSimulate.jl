...
theoph_ev = PMSimulatorBase.df2evs(theoph);
...
cbs = PMSimulatorSimulate.collect_evs([theoph_ev.instances[1].inputs..., theoph_ev.instances[1].updates...], house);
sol = solve(house, callback = cbs);
